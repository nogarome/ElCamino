...
(function ($) {
    ...
    function init(item) {
        ...
        $('#coordinatedImagePreviewControlMainDiv').append();
            ...
            success: function (featureCollection) {
                ...
                for (var i = 0; i < lastImages.length; i++) {
                    ...
                    if(bounds.contains(L.latLng(lastImages[i].geometry.coordinates[1], lastImages[i].geometry.coordinates[0]))){
                       var imgHtml = '<li id="coordinatedImagePreviewControlLi' + i + '" class="coordinatedImagePreviewControlLi"><a class="example-image-link" href="' + lastImages[i].properties.imageLink + '" data-lightbox="example-set" data-title="' + lastImages[i].properties.description + '"><img width="100" height="66.66" class="example-image" src="' + lastImages[i].properties.thumbnailLink + '" alt=""/></a></li>';
